...
const posts = [
  {
    ...
    href: '#',
    category: { name: 'Article', href: '#', color: 'bg-green-100 text-green-800' },
    description:
...
export default function Example() {
  return (
              ...
              <div className="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                <div>
                  <h1 className="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-5xl xl:text-6xl">
                    ...
                    <span className="text-green-500 md:block">Scary Stories</span>
                  </h1>
    ...
    <div className="relative max-w-lg mx-auto divide-y-2 divide-gray-200 lg:max-w-7xl">
      <div>
        <h2 className="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl">Recent stories</h2>
  ...
  <footer className="bg-white border-t border-gray-300 w-1/2 mx-auto">
